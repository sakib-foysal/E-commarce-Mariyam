                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6 pb-3">
                                <div class="product-cart-wrap mb-xs-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div>
                                         @if(Auth::check())
        <a aria-label="Add To Cart" class="btn mt-2 d-block" href="{{ url('/add-to-cart/'.$data->id) }}">
            <i class="fi-rs-shopping-bag-add"></i> Add to Cart
        </a>
    @else
        <a aria-label="Add To Cart" class="action-btn hover-up" href="{{ url('/login3') }}">
            <i class="fi-rs-shopping-bag-add"></i> Add to Cart
        </a>
    @endif
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6 pb-3">
                                <div class="product-cart-wrap mb-xs-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
    @if(Auth::check())
        <a aria-label="Add To Cart" class="action-btn hover-up" href="{{ url('/add-to-cart/'.$data->id) }}">
            <i class="fi-rs-shopping-bag-add"></i> Add to Cart
        </a>
    @else
        <a aria-label="Add To Cart" class="action-btn hover-up" href="{{ url('/login3') }}">
