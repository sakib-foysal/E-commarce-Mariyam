                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                @auth
                                 ...
                                 <div class="header-action-icon-2">
                                    <a href="shop-wishlist.php"><i class="bi bi-chat-heart"></i><span class="pro-count blue">4</span></a>
                                </div>

                                 <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="{{route('orders.index')}}">
                                        <i class="bi bi-cart3"></i>
                                        <span class="pro-count blue">00</span>
                                    </a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Surfside Media" src="{{asset('/SurfsideMedia/assets/imgs/shop/thumbnail-3.jpg')}}"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Surfside Media" src="{{asset('/SurfsideMedia/assets/imgs/shop/thumbnail-2.jpg')}}"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                ...
                <div class="header-wrap header-space-between position-relative">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <!--        <img src="{{asset('/SurfsideMedia/assets/imgs/banner/menu-banner-2.jpg')}}" alt="menu_banner1">-->
                                                ...
                                                <!--    </div>-->
                                                <!--    <div class="header-banner2">-->
                                                <!--        <img src="{{asset('/SurfsideMedia/assets/imgs/banner/menu-banner-3.jpg')}}" alt="menu_banner2">-->
                                                <!--        <div class="banne_info">-->
                                                <!--            <h6>15% Off</h6>-->
                                                <!--            <h4>Hot Deals</h4>-->
                                                <!--            <a href="#">Shop now</a>-->
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <!--                <a href="product-details.html"><img src="{{asset('/SurfsideMedia/assets/imgs/banner/menu-banner.jpg')}}" alt="Surfside Media"></a>-->
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            ...
                            <!--        <img alt="Surfside Media" src="{{asset('/SurfsideMedia/assets/imgs/theme/icons/icon-heart.svg')}}">-->
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="/cart"><img alt="Surfside Media" src="{{asset('/SurfsideMedia/assets/imgs/shop/thumbnail-4.jpg')}}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
